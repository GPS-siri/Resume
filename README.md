...
> Javascript / Typescript / Node 기반의 풀스택 개발자로, 약 5년간 다양한 솔루션 및 서비스 개발에 참여해왔습니다. 사용자와 개발자 모두가 만족할 수 있는 아름다움을 지향하며, 실제 사용자 니즈를 빠르게 파악하고 반영하는 개발을 강점으로 삼고 있습니다.
...
- **자기소개:**
  ...
  - 미를 추구하는 개발자.
    ...
    > 개발하는 모든 영역에서 '미'를 추구합니다. 아름다움 이라는 것이 굉장히 주관적일 수 있지만, 같은 공간에서 일하는 개발자들 사이에는 공통적으로 모두가 비슷하게 혹은 동일하게 생각하는 아름다움이 있을 것 입니다. 예를 들어 작성하는 코드나 제품/기능 에서 발생하는 데이터와 통신의 유려함, 개발하는 제품 구조의 아름다움. 팀원 모두가 납득할 수 있는 '미'가 완성될때 까지 끊임없이 노력 합니다. 나아가 완성된 제품을 사용하는 사람 모두에게 까지 전파되는 아름다움을 추구합니다.

  - 짧은 시간내에 어떻게든 해냈던 개발자. 이제는 더 아름답게 해내는 개발자.

    > 지난 약 5년간 각종 SI 프로젝트에서 프론트엔드 개발자로 활동하고, 회사 내부 솔루션 개발에서는 백엔드 개발자로 활동하면서 어떻게든 주어진 시간내에 완성하기 위해 최선을 다 해 왔습니다. 그 과정에서 빠르게 배우고 적용하는 법을 익혀 왔습니다. 이제는 단순히 완성에 그치지 않고, 더 나은 구조와 경험을 고려하며 개발하려고 노력하고 있습니다. 아직은 Front와 Back 모두 부족한 부분이 많다고 생각하지만, 10년 이내에 스스로 뿐만 아니라 모두가 인정하는 가장 제품/솔루션을 잘 만드는 개발자가 되고 싶습니다. 좋은 것은 무엇이든 흡수하려는 태도로 배우며, 앞으로의 10년을 스스로 기대하는 개발자입니다.

  - 팀원과의 긴밀한 협업과 리뷰를 중요시 하는 개발자.

    > 어떻게 보면 굉장히 당연한 소리입니다. 혼자서 하는 일에는 한계가 더 빨리 찾아오고, 충분한 완성도가 나올 수 없다고 생각합니다. 내가 고려하지 못했던 것을 동료가 생각해주고, 동료가 고려하지 못했던 것을 내가 채워줄 수 있는 상황이 제 커리어 내내 정말 많았습니다. 시간이 허락하는 한 팀원과 많은 코드 리뷰를 하는 것으로 인해 더 아름다운 구조, 코드, 제품이 나올 수 있다고 믿습니다.
