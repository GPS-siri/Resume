...
- **자기소개:**
  ...
  - 맡은 일은 알아서 잘했던 개발자. 이제는 뭐든 잘 만드는 개발자.

    > 근 5년간 각종 SI 프로젝트에서 프론트엔드 개발자로 활동하고, 회사 내부의 솔루션 개발을 진행할때는 백엔드 개발자로 활동하면서 많은 것을 배우고 활용해 왔습니다. 그럼에도 아직은 Front / Back 할 것 없이 모두 부족한 부분이 많다고 생각합니다. 10년 이내에 스스로 뿐만 아니라 모두가 생각하는 가장 제품/솔루션을 잘 만드는 개발자가 되고 싶습니다. 그를 위해 좋은 것은 무엇이든 스펀지 처럼 흡수하려고 노력합니다. 앞으로의 10년이 생각만 해도 즐거운 개발자입니다.
